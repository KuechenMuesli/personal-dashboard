...
<style>
  ...
  .centered-dialog {
    ...
    width: 95vw; max-width: 500px; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); margin: 0;
  }
  ...
  .favorites-scroll { max-height: 300px; overflow-y: auto; display: flex; flex-direction: column; gap: 10px; }
  .edit-row { display: flex; gap: 8px; align-items: center; }

  .color-picker { width: 30px; height: 30px; padding: 0; border: none; background: none; cursor: pointer; }
  .name-in { width: 80px; background: #262626; border: 1px solid #3f3f3f; color: white; border-radius: 4px; padding: 4px; }
  .url-in { flex: 1; background: #262626; border: 1px solid #3f3f3f; color: white; border-radius: 4px; padding: 4px; }

  .del-btn { background: none; border: none; color: #ef4444; font-size: 20px; cursor: pointer; }
  .add-btn { background: #3b82f6; color: white; border: none; padding: 4px 12px; border-radius: 6px; cursor: pointer; }
  ...
  .save { background: #059669; color: white; border: none; padding: 8px 20px; border-radius: 6px; cursor: pointer; font-weight: 600; }
</style>
