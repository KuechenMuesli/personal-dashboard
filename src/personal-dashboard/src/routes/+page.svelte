<script lang="ts">
  ...
  let widgets = $derived({
    ...
    colorPicker:      { name: i18n.t.widgets.colorPicker, load: () => import("$lib/widgets/ColorPicker.svelte"), defaultSize: { width: 1, height: 3 }, hasSettings: false, fixedSize: false, minSize: { width: null, height: null }, maxSize: { width: 2, height: 4 } },
    newtorkMetrics:   { name: i18n.t.widgets.networkMetrics, load: () => import("$lib/widgets/NetworkMetrics.svelte"), defaultSize: { width: 2, height: 1 }, hasSettings: false, minSize: { width: 2, height: 1 }, maxSize: { width: 3, height: 3 }, maxCount: null },
    ...
    github:           { name: i18n.t.widgets.github, load: () => import("$lib/widgets/GitHub.svelte"), defaultSize: { width: 2, height: 5 }, hasSettings: true, minSize: { width: 1, height: 2 }, maxSize: { width: null, height: null } },
